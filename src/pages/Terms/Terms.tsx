...
const Terms = () => {
  return (
    <Container>
      <SectionHeading title="Terms and Conditions" text="" width="w-1/3" />
      <div className="space-y-2">
        ...
        <ul className="list-disc ml-5">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to RideWave, Cox's Bazar, Chittagong.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to RideWave, accessible from{" "}
              <a
                href="https://bike-rental-service-ctg.netlify.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://bike-rental-service-ctg.netlify.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul className="list-disc ml-5">
          <li>
            ...
            <a
              href="https://bike-rental-service-ctg.netlify.app/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://bike-rental-service-ctg.netlify.app/contact-us
            </a>
          </li>
        </ul>
      </div>
